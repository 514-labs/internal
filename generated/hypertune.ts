...
export const queryCode = `query FullQuery{root{experimental exampleFlag}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"experimental":{"fieldArguments":{},"fieldQuery":null},"exampleFlag":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"experimental":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/7598/main/draft/logic?selected_field_path=root%3Eexperimental","description":"Experimental features not yet ready for general internal use"},"exampleFlag":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/7598/main/draft/logic?selected_field_path=root%3EexampleFlag"}};
...
export type Root = {
  /**
   * Experimental features not yet ready for general internal use
   */
  experimental: boolean;
  exampleFlag: boolean;
}

const rootFallback = {experimental:false,exampleFlag:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * Experimental features not yet ready for general internal use
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/7598/main/draft/logic?selected_field_path=root%3Eexperimental})
   */
  experimental({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("experimental", { fieldArguments: args });
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/7598/main/draft/logic?selected_field_path=root%3EexampleFlag})
   */
...
const sourceFallback = {root:{experimental:false,exampleFlag:false}};
