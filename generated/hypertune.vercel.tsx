...
import { getOverrideFromOverridesList, DeepPartial, ObjectValue, Value } from "hypertune";
...
export async function getVercelOverride(): Promise<DeepPartial<hypertuneTypes.Source> | null> {
  ...
  const decryptedOverrides = await decryptOverrides(
  ...
  return getOverrideFromOverridesList(Object.entries(decryptedOverrides) as [flagPath: string, value: Value | null][]);
}
