...
const journeyLabels: Record<string, string> = {
  "boreal-onboarding": "Onboarding",
  "boreal-activation": "Activation",
  "boreal-retention": "Retention",
};

export function BorealJourneysCard({
  startDate,
  endDate,
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Boreal User Journeys</CardTitle>
        <CardDescription>
          Hosting service user progression and conversion funnels
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs
